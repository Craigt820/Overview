...
public class GroupDetailsController_ implements Initializable {
    @FXML
    private Label close;
    ...
    public static class Overview extends GridPane {
        ...
        private LocalDateTime dateScanned;
        private String pallet;
        private boolean releasedToProd;
        ...
        public Overview(String id, LocalDateTime timeStamp, int pages, String description, String employee, String status,String condition) {
            this.pages = pages;
            this.id = id;
            this.description = description;
