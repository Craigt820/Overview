...
public class Group<T extends Control> {
    ...
    public Group(int id, Collection collection, String barcode, String name, ArrayList<String> emps, String status, String location, int total) {
        this.id = id;
        ...
        this.location = new ComboBox<>(FXCollections.observableArrayList("Rack #1", "Rack #2", "Rack #3", "Rack #4", "Rack #5"));
